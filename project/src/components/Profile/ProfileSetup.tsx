                        ...
                        <>
                            <div className="border-t border-gray-200 pt-4 sm:pt-6 space-y-4 sm:space-y-6 mt-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div><label htmlFor="pharmacy_name" className="block text-sm font-medium text-gray-700 mb-1">Apotekets/företagets namn</label><input type="text" name="pharmacy_name" id="pharmacy_name" value={profileData.pharmacy_name || ''} onChange={handleInputChange} className="input-form" /></div>
                                    <div><label htmlFor="pharmacy_manager_name" className="block text-sm font-medium text-gray-700 mb-1">Ansvarig Chef</label><input type="text" name="pharmacy_manager_name" id="pharmacy_manager_name" value={profileData.pharmacy_manager_name || ''} onChange={handleInputChange} className="input-form" /></div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

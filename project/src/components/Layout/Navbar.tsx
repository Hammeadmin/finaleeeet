...
import {
  Pill, User, LogOut, CalendarIcon, Home, Calendar, MessageCircle, Info, Briefcase, Phone, Users as ApplicantsIcon, Building2, DollarSign,
...
export function Navbar({ session, profile }: NavbarProps) {
  ...
  const publicNavItems = [
    ...
    { path: '/for-apotek', icon: Building2, label: 'För arbetsgivare', description: 'Information för arbetsgivare' },

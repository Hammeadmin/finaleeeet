...
export function ProfilePage() {
  ...
  useEffect(() => {
    // This keeps the URL in sync with the active tab
  ...
  {activeTab === 'settings' && (
    <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow">
      ...
      <div className="space-y-8">
        ...
        {/* == Conditional Settings for Employers == */}
        {!isEmployee && (
          <div>
            <h3 className="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Företagsinställningar</h3>
            <BillingSettings />
          </div>
        )}
